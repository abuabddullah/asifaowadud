    ...
    <section id="services" className="text-gray-600 body-font ">
      <div className="container px-5 py-24 mx-auto  overflow-hidden">
        ...
        <div
          ...
          className="stats grid stats-vertical lg:stats-horizontal shadow mb-8 hover:text-white hover:bg-black transition-all overflow-hidden group"
        >
        ...
        <div
          data-aos="zoom-in"
          data-aos-duration="1000"
          className="stats grid stats-vertical lg:stats-horizontal shadow mb-8 hover:text-white hover:bg-black transition-all group"
        >
          <div className="stat text-center">
            <span className="bg-black text-white p-4 rounded-full text-3xl mx-auto group-hover:bg-white group-hover:text-black ">
              <AiOutlineAntDesign />
