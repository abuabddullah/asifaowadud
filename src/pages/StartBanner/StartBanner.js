        ...
        <div id='openingBanner'>
            <div className="hero min-h-screen bg-[#B1C0CB]">
                <div className="hero-content flex-col lg:flex-row-reverse text-white">
                    ...
                    <div>
                        <h1 className="text-5xl font-bold">Hello! I'M <span className='text-black'>ASIF</span> </h1>
                        <h2 className='text-3xl py-6'>I am a <span className='font-bold text-red-500'>Web Developer</span></h2>
                        <Link to='/home'><button className="btn btn-wide btn-outline text-xl rounded-none rounded-bl-3xl rounded-tr-3xl hover:rounded-none transition-all">
                            Let's start 
                            <span 
