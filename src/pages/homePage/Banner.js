    ...
    return (
        <section id='banner' class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center overflow-hidden">
                    ...
                    <p
                        data-aos="fade-right"
                        data-aos-delay="200"
                        class="mb-8 leading-relaxed">I am a hard working passionate developer and  veritably flexible and adaptive to learning new stuff. I like to take challenge. I am expert in React js, vanilla javascript, HTML 5, CSS 3, Bootstrap 5, Tailwind. And comfotable with Node, MongoDB.
                    ...
                    >
                        <a
                            ...
                            data-aos-delay="700"
                            href='#contact'
                            class="inline-flex text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-black rounded text-lg">Hire Me</a>
                        <a
                            data-aos="fade-down"
                            data-aos-delay="700"
