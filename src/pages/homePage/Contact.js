...
//                         <input id='name' class="block w-full px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" 
//                         type="text" 
//                         />
//                     </div>

//                     <div class="w-full mx-2 mt-4 md:mt-0">
//                         <label htmlFor='email' class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200">E-mail</label>

//                         <input id='email' class="block w-full px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" type="email" />
//                     </div>
//                 </div>

//                 <div class="w-full mt-4">
//                     <label htmlFor='message' class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200">Message</label>

//                     <textarea id='message' class="block w-full h-40 px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"></textarea>
//                 </div>
            ...
            <form
                ...
                <div class="items-center -mx-2 md:flex">
                    ...
                    <div class="w-full mx-2 mt-4 md:mt-0">
                        ...
                        <input id='email' class="block w-full px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                            type="email"
                            name='reply_to'
                ...
                <div class="w-full mt-4">
                    ...
                    <textarea id='message' class="block w-full h-40 px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"
                        name='message'
