                ...
                <div class="mt-8 xl:mt-12 lg:flex lg:items-center">
                    <div class="w-full lg:w-1/2 grid grid-cols-1 gap-8 xl:gap-16 md:grid-cols-2">
                        <div class="space-y-3">
                            ...
                            <img src={blog1} alt="" className='h-24 w-full object-cover' />


                            <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">What is the purpose of JWT and how does it work</h1>

                            <p class="text-gray-500 dark:text-gray-300">
                            JWT stands for Json Web Token. Which is an open standard it helps to share information between client...
                            </p>
                            <p class="text-gray-500 dark:text-gray-300">
                                <a href="https://thirstydrinks-11.web.app/blogs/626f4d65bd49ccaf469da148" target="_blank" rel="noopener noreferrer">Read More<BiLinkExternal />
                                </a>
                            </p>
                        </div>
                        <div class="space-y-3">
                            ...
                            <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Differences between SQL and NoSQL databases</h1>

                            <p class="text-gray-500 dark:text-gray-300">
                            SQL stands for Structured Query Language. It helps us to get, create, read data from database depending on query...
                            </p>
                            <p class="text-gray-500 dark:text-gray-300">
                                <a href="https://thirstydrinks-11.web.app/blogs/626f4ce2bd49ccaf469da147" target="_blank" rel="noopener noreferrer">Read More<BiLinkExternal />
                                </a>
                            </p>
                        </div>
                        <div class="space-y-3">
                            ...
                            <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">When should you use nodejs and when should you use mongodb</h1>
                            ...
                            <p class="text-gray-500 dark:text-gray-300">
                                <a href="https://thirstydrinks-11.web.app/blogs/626f4c96bd49ccaf469da146" target="_blank" rel="noopener noreferrer">Read More<BiLinkExternal />
                                </a>
                            </p>
                        </div>
                        <div class="space-y-3">
                            ...
                            <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Difference Between Javascript And Nodejs</h1>

                            <p class="text-gray-500 dark:text-gray-300">
                                JavaScript (i.e. vanilla JS) is scripting programming language. Its the very basic language for the web development...
                            </p>
                            <p class="text-gray-500 dark:text-gray-300">
                                <a href="https://thirstydrinks-11.web.app/blogs/626f4c0ebd49ccaf469da145" target="_blank" rel="noopener noreferrer">Read More<BiLinkExternal />
                                </a>
                            </p>
                        </div>
