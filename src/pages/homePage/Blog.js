    ...
    return (
        ...
        <section id='blog' className="bg-white dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto overflow-hidden">
                <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">My Blogs</h1>
                    ...
                    <div className="w-full lg:w-1/2 grid grid-cols-1 gap-8 xl:gap-16 md:grid-cols-2 overflow-hidden">
                        {
                            blogs.map((blog, index) =>
                                <div
                                    ...
                                    className="space-y-3 hover:shadow-md p-4 rounded-lg"
                                    key={index}
                                >
                                    ...
                                    <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">{blog.title}</h1>
                ...
                <div className='text-center mt-12'>
                    <Link to="/allBlogs"   className="btn btn-wide font-bold">All Blogs →</Link>
                </div>
            </div>
        </section>
    );
